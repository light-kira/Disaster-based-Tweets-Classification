...
class KeywordExtractTest{
	...
	public static void main(String[] args) throws IOException{
		...
		for(int i=0;i<lines.size();i++){
			...
			try{
				PrintWriter writer = new PrintWriter("test/"+filename,"UTF-8"); //Writing the .txt files
				writer.println(temp);
				writer.close();
			}
			catch (IOException e) {
			...
			try{
				PrintWriter writer1 = new PrintWriter("test_key/"+filename1,"UTF-8");
